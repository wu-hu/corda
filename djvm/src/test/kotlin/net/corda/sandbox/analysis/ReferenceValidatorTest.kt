...
class ReferenceValidatorTest : TestBase() {
    ...
    private val validator = ReferenceValidator(AnalysisConfiguration())

    @Test
    fun `can validate when there are no references`() = analyze {
        val context = context
    ...
    @Test
    fun `can validate when there are references`() = analyze {
        val context = context
    ...
    @Test
    fun `can validate when there are transient references`() = analyze {
        val context = context
